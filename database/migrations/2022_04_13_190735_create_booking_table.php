...
class CreateBookingTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('booking', function (Blueprint $table) {
            $table->id();
            $table->foreignId('calendar_setting_id')->constrained('calendar_setting')->cascadeOnUpdate()->cascadeOnDelete()->comment("Calendar Setting ID");
    ...
    public function down()
    {
        Schema::table('booking', function (Blueprint $table) {
            $table->dropForeign(['calendar_setting_id']);
